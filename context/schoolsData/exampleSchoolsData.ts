...
export const faculty = [
    ...
    { name: "Kierunek prawno-ekonomiczny", id: 139, features_traits_1: [5, 10, 19, 23, 31], features_traits_2: [6, 11, 20, 24, 32], features_hard_1: [3, 13, 21, 28, 34], features_hard_2: [4, 9, 22, 30, 36] },
    { name: "Kognitywistyka", id: 140, features_traits_1: [1, 7, 15, 22, 30], features_traits_2: [2, 8, 16, 23, 31, 204], features_hard_1: [6, 12, 20, 30, 37], features_hard_2: [4, 13, 22, 28, 35] },
    { name: "Kulturoznawstwo", id: 141, features_traits_1: [4, 12, 18, 25, 34], features_traits_2: [5, 13, 19, 26, 35], features_hard_1: [3, 11, 21, 30, 36], features_hard_2: [6, 9, 22, 28, 35] },
    { name: "Logopedia", id: 142, features_traits_1: [6, 9, 14, 21, 30], features_traits_2: [7, 10, 15, 22, 31], features_hard_1: [4, 13, 20, 30, 35], features_hard_2: [5, 12, 22, 28, 37] },
    { name: "Matematyka", id: 143, features_traits_1: [3, 11, 17, 24, 33], features_traits_2: [4, 12, 18, 25, 34], features_hard_1: [6, 9, 21, 28, 35], features_hard_2: [5, 10, 22, 30, 37] },
    { name: "Matematyka w finansach", id: 144, features_traits_1: [2, 8, 14, 21, 32], features_traits_2: [3, 9, 15, 22, 33], features_hard_1: [4, 12, 20, 30, 35], features_hard_2: [5, 11, 22, 28, 37] },
    { name: "Matematyka z informatyką", id: 145, features_traits_1: [5, 10, 19, 23, 31], features_traits_2: [6, 11, 20, 24, 32], features_hard_1: [3, 13, 21, 28, 34], features_hard_2: [4, 9, 22, 30, 35] },
