...
const ProfileView: React.FC<ProfileProps> = ({ name, description, schools, softSkills, hardSkills }) => {
  return (
    <Paper elevation={3} sx={{ p: 3, maxWidth: 800, mx: 'auto', mt: 5, borderRadius: 2, bgcolor: '#f5f5f5' }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h5" sx={{ color: '#A758B5', mb: 2, fontWeight:'800' }}>Ukończone szkoły</Typography>
        <Box sx={{ pl: 2 }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={7}>
          <Typography variant="h5" sx={{color: '#A758B5', mb: 2, fontWeight:'800'}}>Cechy miękkie</Typography>
          <Box sx={{ pl: 2 }}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h5" sx={{color: '#A758B5', mb: 2, fontWeight:'800'}}>Cechy twarde</Typography>
          <Box sx={{ pl: 2 }}>
