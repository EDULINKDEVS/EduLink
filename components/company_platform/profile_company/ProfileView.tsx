...
const ProfileView: React.FC<ProfileProps> = ({ name, description, sectors, positions, hardSkills }) => {
  ...
  return (
    <Paper elevation={3} sx={{ p: 3, maxWidth: 800, mx: 'auto', mt: 5, borderRadius: 2, bgcolor: '#f5f5f5' }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h5" sx={{ color: theme.palette.primary.main, mb: 2, fontWeight:'800' }}>Obsługiwane branże</Typography>
        <Box sx={{ pl: 2 }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={7}>
          <Typography variant="h5" sx={{color: theme.palette.primary.main, mb: 2, fontWeight:'800'}}>Poszukiwane stanowiska</Typography>
          <Box sx={{ pl: 2 }}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h5" sx={{color: theme.palette.primary.main, mb: 2, fontWeight:'800'}}>Poszukiwane cechy pracownika</Typography>
          <Box sx={{ pl: 2 }}>
